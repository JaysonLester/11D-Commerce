        ...
        <div className="mx-80 my-8">
          <form onSubmit={handleSubmit}>
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-6">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className={`block w-1/2 rounded-md border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-zinc-600 sm:text-sm sm:leading-6`}
              ...
              {/* New Password */}
              <div className={`mt-6 ${isOldPasswordCorrect ? '' : 'hidden'}`}>
                <label
